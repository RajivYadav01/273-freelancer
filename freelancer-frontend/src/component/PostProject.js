            ...
            <form id="formbox" onSubmit={this.onFormSubmit}>
                ...
                <div id="drpdwn">
                    ...
                    <select id="range" name="drp2" onChange = {this.handleChange}>
                        <option value="1" label="Micro Project ($10 - 30 USD)">Micro Project ($10 - 30 USD)</option>
                        <option value="2" label="Simple project ($30 - 250 USD)">Simple project ($30 - 250 USD)</option>
                        <option value="3" label="Very small project ($250 - 750 USD)">Very small project ($250 - 750 USD)</option>
                        <option value="4" label="Small project ($750 - 1500 USD)">Small project ($750 - 1500 USD)</option>
                    </select>
                </div>
                <br/> <br/> <br/>
                <input type="submit" className="btn btn-warning btn-lg" href="/addproject" value="Post My Project"/>
            </form>
        );
    }
}
